...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <a class="w3-button w3-indigo" href="">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{url('home/profile')}}" target = "_blank" class="d-block">Admin Zuccedd</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('home/chartjs')}}" class="nav-link"  target="_blank">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Different Charts</p>
                </a >
              </li>
              <li class="nav-item">
                <a href="{{url('home/inline')}}" class="nav-link"  target="_blank">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Inline</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('home/datatable')}}" class="nav-link"  target="_blank">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{url('home/calendar')}}" class="nav-link"  target="_blank">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('home/changepass')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
