...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="http://127.0.0.1:8000/admin" class="brand-link">
      <img src="\public\dist\img\logo.png" class="brand-image img-circle elevation-3">
      <span class="brand-text font-weight-light">Zuccedd</span>
    </a>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div id="external-events">
                    ...
                    <div class="external-event bg-warning">Update sales Record</div>
                    <div class="external-event bg-info">Update Gross Amount</div>
                    <div class="external-event bg-primary">Work on UI design</div>
                    <div class="external-event bg-danger">authenticate sales page</div>
                    <div class="checkbox">
                      <label for="drop-remove">
                        <input type="checkbox" id="drop-remove">
                        Deletion of events after drop
                      </label>
                    </div>
                  </div>
                </div>
