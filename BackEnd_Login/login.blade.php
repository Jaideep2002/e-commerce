...
<img src="\dist\images\header\zucced1.png" width= "200" height = "68" alt="Zuccedd">
   ...
   <script>window.location="/home/login/dashboard";</script>
  @endif
   ...
   @endif
			...
			<form class="login" action="{{url('/home/checklogin')}}" method="post" autocomplete="off">
                {{ csrf_field() }}
                <div class="login__field">
			</br>
			<input type="email" name="email" placeholder="Admin Mail ID" class="login__input" />
                    {{-- <input autocorrect = "off" autocapitalize = "off" autocomplete = "on" type="email" class="login__input"placeholder="Enter Admin MailID" name="email" /> --}}
                </div>
				<div class="login__field">
                    ...
                    {{-- <input type="password" class="login__input"placeholder="Enter Password" name="password" /> --}}
				</div>
